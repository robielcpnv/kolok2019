...
<form class="form-horizontal" role="form" method="post">
  ...
  <div class="form-group <?php echo isset($username_error) ? 'has-error' : '' ?>">
    ...
    <input type="text" class="form-control" id="username" name="username" placeholder="Identifiant" value="<?= isset($username) ? htmlspecialchars($username) : '' ?>">
  ...
  <div class="form-group <?php echo isset($name_error) ? 'has-error' : '' ?>">
    ...
    <input type="text" class="form-control" id="name" name="name" placeholder="Nom complet" value="<?= isset($name) ? htmlspecialchars($name) : '' ?>">
  ...
  <div class="form-group <?php echo isset($email_error) ? 'has-error' : '' ?>">
    ...
    <input type="text" class="form-control" id="email" name="email" placeholder="Email" value="<?= isset($email) ? htmlspecialchars($email) : '' ?>">
